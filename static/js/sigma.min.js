...
(function(){
    if(!Array.prototype.some)Array.prototype.some=function(i,m){
        ...
        for(var j=0;j<f;j++)if(j in this&&i.call(m,this[j],j,this))return!0;return!1
    };
    ...
    if(!Object.keys)Object.keys=function(){
        var i=Object.prototype.hasOwnProperty,m=!{
            toString:null
        }.propertyIsEnumerable("toString"),f="toString,toLocaleString,valueOf,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,constructor".split(","),
        j=f.length;
        return function(n){
            if("object"!==typeof n&&"function"!==typeof n||null===n)throw new TypeError("Object.keys called on non-object");
            var u=[],r;
            for(r in n)i.call(n,r)&&u.push(r);if(m)for(r=0;r<j;r++)i.call(n,f[r])&&u.push(f[r]);
            return u
        }
    }()
})();
sigma.classes.Cascade=function(){
    ...
    this.config=function(i,m){
        ...
        for(var j in f)void 0!=this.p[j]&&(this.p[j]=f[j]);return this
    }
};
...
(function(){
    ...
    function m(){
        ...
        this.addNode=function(a,b){
            ...
            for(g in b)switch(g){
                case "id":
                    break;
                case "x":case "y":case "size":
                    c[g]=+b[g];
                    break;
                case "fixed":case "active":case "hidden":case "forceLabel":
                    c[g]=!!b[g];
                    break;
        ...
        this.iterEdges=function(a,b){
            ...
            c.forEach(function(a,c){
                var b=g[c],k;
                for(k in b)switch(k){
                    case "id":case "displaySize":
                        break;
                    case "weight":case "size":
                        a[k]=+b[k];
                        break;
                    ...
                    case "hidden":
                        a[k]=!!b[k];
                        break;
                    case "color":case "label":case "type":
                        a[k]=(b[k]||"").toString();
                        break;
                    default:
                        a.attr[k]=b[k]
        ...
        this.iterNodes=function(a,g){
            ...
            c.forEach(function(a,
                ...
                var b=l[c],d;
                for(d in b)switch(d){
                    case "id":case "attr":case "degree":case "inDegree":case "outDegree":case "displayX":case "displayY":case "displaySize":
                        break;
                    case "x":case "y":case "size":
                        a[d]=+b[d];
                        break;
    ...
    function f(b,l){
        function g(){
            ...
            for(var b in d.p.globalProbes)a+="<p>"+b+" : "+
                d.p.globalProbes[b]()+"</p>";a+="<br><p>LOCAL :</p>";
            for(b in d.p.localProbes)a+="<p>"+b+" : "+d.p.localProbes[b]()+"</p>";d.p.dom.innerHTML=a;
            return d
        }
        sigma.classes.Cascade.call(this);
        var d=this;
    ...
    function u(b,l){
        ...
        this.draw=function(a,b,d,l){
            ...
            for(var f in c.domElements)"canvas"==c.domElements[f].nodeName.toLowerCase()&&(void 0==l[f]||0<=l[f])&&c.domElements[f].getContext("2d").clearRect(0,0,c.domElements[f].width,c.domElements[f].height);c.plotter.currentEdgeIndex=0;
            c.plotter.currentNodeIndex=0;
            c.plotter.currentLabelIndex=0;
            f=null;
            l=!1;
            if(a)if(1<a)for(;c.plotter.task_drawNode(););else sigma.chronos.addTask(c.plotter.task_drawNode,"node_"+c.id,!1),l=!0,f="node_"+
                c.id;
            if(d)if(1<d)for(;c.plotter.task_drawLabel(););else f?sigma.chronos.queueTask(c.plotter.task_drawLabel,"label_"+c.id,f):sigma.chronos.addTask(c.plotter.task_drawLabel,"label_"+c.id,!1),l=!0,f="label_"+c.id;
            if(b)if(1<b)for(;c.plotter.task_drawEdge(););else f?sigma.chronos.queueTask(c.plotter.task_drawEdge,"edge_"+c.id,f):sigma.chronos.addTask(c.plotter.task_drawEdge,"edge_"+c.id,!1),l=!0,f="edge_"+c.id;
            c.dispatch("draw");
            c.refresh();
        ...
        this.resize=function(a,
            ...
            if(d!=c.width||g!=c.height){
                for(var f in c.domElements)c.domElements[f].setAttribute("width",c.width+"px"),c.domElements[f].setAttribute("height",c.height+"px");c.plotter.resize(c.width,c.height);
    ...
    sigma.debugMode=0;
    sigma.log=function(){
        if(1==sigma.debugMode)for(var b in arguments)console.log(arguments[b]);else if(1<sigma.debugMode)for(b in arguments)throw Error(arguments[b]);return sigma
    };
